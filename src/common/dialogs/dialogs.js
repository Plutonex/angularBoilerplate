 ...
 */
.controller('warningDialogCtrl', ['$scope', '$modalInstance', 'msg',
    function($scope, $modalInstance, msg) {
        //-- Variables -----//
...
.run(['$templateCache',
    function($templateCache) {
        $templateCache.put('/dialogs/warning.html', '<div class="modal-header dialog-header-warning"><button type="button" class="close" ng-click="close()">&times;</button><h4 class="modal-title text-danger"><span class="glyphicon glyphicon-warning-sign"></span> {{header}}</h4></div><div class="modal-body text-danger" ng-bind-html="msg"></div><div class="modal-footer"><button type="button" class="btn btn-primary" ng-click="close()">Close</button></div>');
        $templateCache.put('/dialogs/error.html', '<div class="modal-header dialog-header-error"><button type="button" class="close" ng-click="close()">&times;</button><h4 class="modal-title text-danger"><span class="glyphicon glyphicon-warning-sign"></span> {{header}}</h4></div><div class="modal-body text-danger" ng-bind-html="msg"></div><div class="modal-footer"><button type="button" class="btn btn-primary" ng-click="close()">Close</button></div>');
